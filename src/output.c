...
static void output_function(offset(Function*) function, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_method(Method* method, FILE* outfile, size_t indent)`
static void output_method(offset(Method*) method, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_class_member(ClassMember* class_member, FILE* outfile, size_t indent)`
static void output_class_member(offset(ClassMember*) class_member, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_class(Class* class, FILE* outfile, size_t indent)`
static void output_class(offset(Class*) class, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_variable(Variable* variable, FILE* outfile, size_t indent)`
static void output_variable(offset(Variable*) variable, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_statement(Statement* statement, FILE* outfile, size_t indent)`
static void output_statement(offset(Statement*) statement, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_if(If* if_, FILE* outfile, size_t indent)`
static void output_if(offset(If*) if_, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_else_if(ElseIf* else_if, FILE* outfile, size_t indent)`
static void output_else_if(offset(ElseIf*) else_if, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_for(For* for_, FILE* outfile, size_t indent)`
static void output_for(offset(For*) for_, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_while(While* while_, FILE* outfile, size_t indent)`
static void output_while(offset(While*) while_, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_expression(Expression* expression, FILE* outfile, size_t indent)`
static void output_expression(offset(Expression*) expression, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_primary(Primary* primary, FILE* outfile, size_t indent)`
static void output_primary(offset(Primary*) primary, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_variable_access(VariableAccess* variable_access, FILE* outfile, size_t indent)`
static void output_variable_access(offset(VariableAccess*) variable_access, FILE* outfile, size_t indent, offset(Parser*) parser);
// `static void output_name(Name* name, FILE* outfile, size_t indent)`
static void output_name(offset(Name*) name, FILE* outfile, size_t indent, offset(Parser*) parser);

void output_code_member(offset(CodeMember*) code_member, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_import(offset(Import*) import, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_function(offset(Function*) function, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_method(offset(Method*) method, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_class_member(offset(ClassMember*) class_member, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_class(offset(Class*) class, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_variable(offset(Variable*) variable, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_statement(offset(Statement*) statement, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_if(offset(If*) if_, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_else_if(offset(ElseIf*) else_if, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_for(offset(For*) for_, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_while(offset(While*) while_, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_expression(offset(Expression*) expression, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
    ...
    if (expression_ptr->operator == OP_NONE) {
        OUT(0, true, "primary\n");
        output_primary(expression_ptr->left, outfile, indent + 1, parser);
    } else {
        ...
        OUT(0, false, "left\n");
        output_expression(expression_ptr->left, outfile, indent + 1, parser);
        OUT(0, true, "right\n");
        output_expression(expression_ptr->right, outfile, indent + 1, parser);
    }
}
void output_primary(offset(Primary*) primary, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_variable_access(offset(VariableAccess*) variable_access, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
...
void output_name(offset(Name*) name, FILE* outfile, size_t indent, offset(Parser*) parser) {
#ifdef DEBUG
