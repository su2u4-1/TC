...
.L27:
        ...
        ret
.LC56:
        .ascii "C:\\Windows\\TEMP\\compiler-explorer-compilerxjSFJv\\example.c\0"
.LC57:
...
to_lower:
        ...
        mov     eax, ecx
        mov     BYTE PTR 16[rbp], al
        cmp     BYTE PTR 16[rbp], 64
        jle     .L57
        cmp     BYTE PTR 16[rbp], 90
        jg      .L57
...
to_upper:
        ...
        mov     eax, ecx
        mov     BYTE PTR 16[rbp], al
        cmp     BYTE PTR 16[rbp], 96
        jle     .L61
        cmp     BYTE PTR 16[rbp], 122
        jg      .L61
        movzx   eax, BYTE PTR 16[rbp]
        sub     eax, 32
        jmp     .L63
